  ...
  const handleResponseSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(
        `/route-requests/${selectedRequest._id}/respond`,
        responseData,
      );
      ...
      if (response.data.success) {
        ...
        notify(response.data.message || "Failed to submit response");
      }
    } catch (error) {
      console.error("Error submitting response:", error);
      notify("Error submitting response");
    }
  };
              ...
              {demandData.highDemandRoutes.map((route, index) => {
                ...
                return (
                  <div key={index} className="route-card">
                    ...
                    <button className="create-route-btn">Create Route</button>
                  </div>
                );
              })}
            </div>
        ...
        <div className="response-modal-overlay">
          <div className="response-modal">
            ...
            <div className="request-summary">
              ...
              <p>
                <strong>Route:</strong> {selectedRequest.fromLocation} →{" "}
              ...
              <p>
                <strong>Frequency:</strong> {selectedRequest.frequency}
              </p>
            </div>
