...
function B2B_RoutesTab({ routes, onRefresh, onAddRoute }) {
  ...
  return (
    <div className="drivemego-btobrt-b2b-routes-tab">
      <div className="drivemego-btobrt-b2b-routes-filters">
        <div className="drivemego-btobrt-b2b-filter-buttons">
          <button
            className={`drivemego-btobrt-b2b-filter-btn ${filter === "all" ? "drivemego-btobrt-active" : ""}`}
            onClick={() => setFilter("all")}
          >
            All Routes ({routes.length})
          </button>
          <button
            className={`drivemego-btobrt-b2b-filter-btn ${filter === "active" ? "drivemego-btobrt-active" : ""}`}
          ...
          <button
            className={`drivemego-btobrt-b2b-filter-btn ${filter === "inactive" ? "drivemego-btobrt-active" : ""}`}
      ...
      {filteredRoutes.length === 0 ? (
        <div className="drivemego-btobrt-b2b-empty-state">
          <div className="drivemego-btobrt-b2b-empty-icon">
            <svg
              width="64"
              height="64"
              viewBox="0 0 24 24"
          ...
          <h3 className="drivemego-btobrt-b2b-empty-title">
            {filter === "all" ? "No Routes Created" : `No ${filter} routes`}
          </h3>
          <p className="drivemego-btobrt-b2b-empty-description">
            {filter === "all"
          ...
          {filter === "all" && (
            <button
              className="drivemego-btobrt-b2b-add-route-btn"
              onClick={onAddRoute}
            >
              + Add New Route
            </button>
        ...
        <div className="drivemego-btobrt-b2b-routes-grid">
