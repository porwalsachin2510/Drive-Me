...
const walletSchema = new mongoose.Schema(
    {
        ...
        role: {
            type: String,
            enum: ["COMMUTER", "CORPORATE", "CORPORATE_EMPLOYEE", "SCHOOL_STUDENT", "SCHOOL_CUSTOMER", "SCHOOL_PARTNER", "SCHOOL_PARTNER_DRIVER", "SCHOOL_CUSTOMER_DRIVER", "B2C_PARTNER", "B2C_PARTNER_DRIVER", "B2B_PARTNER", "B2B_PARTNER_DRIVER", "CORPORATE_DRIVER", "ADMIN", "DEMAND_FIELD", "DEMAND_FINANCE"],
            required: true,
        },
