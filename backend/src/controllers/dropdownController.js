...
const defaultDropdownOptions = [
    ...
    },
    {
        ...
        description: "Budget ranges for daily rentals",
        isSystemDefault: true,
        options: [
            { value: "0-1500", label: "Less than 1,500 AED (Budget)", order: 1 },
            { value: "1500-3000", label: "1,500-3,000 AED (Economy)", order: 2 },
            { value: "3000-6000", label: "3,000-6,000 AED (Standard)", order: 3 },
            { value: "6000+", label: "6,000+ AED (Premium)", order: 4 },
        ],
    },
    {
        category: "BUDGET_RANGES_WEEKLY",
        name: "Weekly Budget Ranges",
        description: "Budget ranges for weekly rentals",
        isSystemDefault: true,
        options: [
            { value: "0-9000", label: "Less than 9,000 AED (Budget)", order: 1 },
            { value: "9000-18000", label: "9,000-18,000 AED (Economy)", order: 2 },
            { value: "18000-35000", label: "18,000-35,000 AED (Standard)", order: 3 },
            { value: "35000+", label: "35,000+ AED (Premium)", order: 4 },
        ],
    },
    {
        category: "BUDGET_RANGES_MONTHLY",
        name: "Monthly Budget Ranges",
        description: "Budget ranges for monthly rentals",
        isSystemDefault: true,
        options: [
            { value: "0-10000", label: "Less than 10,000 AED (Budget)", order: 1 },
            { value: "10000-25000", label: "10,000-25,000 AED (Economy)", order: 2 },
            { value: "25000-50000", label: "25,000-50,000 AED (Standard)", order: 3 },
            { value: "50000+", label: "50,000+ AED (Premium)", order: 4 },
        ],
    },
    {
        category: "BUDGET_RANGES_LONGTERM",
        name: "Long-term Budget Ranges",
        description: "Budget ranges for long-term rentals",
        isSystemDefault: true,
        options: [
            { value: "0-8000", label: "Less than 8,000 AED/month (Budget)", order: 1 },
            { value: "8000-20000", label: "8,000-20,000 AED/month (Economy)", order: 2 },
            { value: "20000-40000", label: "20,000-40,000 AED/month (Standard)", order: 3 },
            { value: "40000+", label: "40,000+ AED/month (Premium)", order: 4 },
        ],
    },
    {
